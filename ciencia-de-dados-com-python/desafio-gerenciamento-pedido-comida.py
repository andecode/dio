...
um cupom de desconto (10% ou 20%) e exibir o valor total de todos os pedidos realizados até o momento, 
...
Saída
O programa deve exibir uma única linha contendo o valor total de todos os pedidos com o desconto 
